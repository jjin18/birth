...
const outside:Record<Focus,View>={home:{p:[11,9,14],t:[-2,.55,0],zoom:1},window:{p:[4,4.5,11],t:[0,1.7,-2],zoom:1.45},gloves:{p:[7,7,10],t:[2.24,1.15,2.7],zoom:1.8},fortune:{p:[8,6,9],t:[1.85,1.25,1.91],zoom:1.8},paperclip:{p:[8,6,9],t:[2.44,1.04,1.75],zoom:1.8},wall:{p:[7,5,10],t:[-3.7,1.65,-.8],zoom:1.75},bed:{p:[7,7,10],t:[-2,0,-.4],zoom:1.25}};
const inside:Record<Focus,View>={home:{p:[4.4,2.35,5.4],t:[-.45,1.25,-.7],zoom:1},window:{p:[.8,2,2],t:[0,1.85,-3.5],zoom:1},gloves:{p:[4.2,2.1,4.2],t:[2.24,1.15,2.7],zoom:1},fortune:{p:[4.2,2.05,4.2],t:[1.85,1.25,1.91],zoom:1},paperclip:{p:[4.3,2.2,3.8],t:[2.44,1.04,1.75],zoom:1},wall:{p:[-.7,2.1,2.4],t:[-4.8,2.1,-.6],zoom:1},bed:{p:[.5,2.1,2.2],t:[-2.4,.85,-.5],zoom:1}};
