...
const zones={tokyo:['+09:00','+09:00'],'new-york':['-05:00','-04:00'],paris:['+01:00','+02:00'],taipei:['+08:00','+08:00'],'san-francisco':['-08:00','-07:00']};
...
for(const date of ['2026-03-29T12:00:00+02:00','2026-10-25T12:00:00+01:00'])assert.equal(getDaylight(cities[2],new Date(date)).mode,'day','Paris DST boundary');
...
console.log('PASS: 5 cities × 3 sky modes, seasonal changes, sunrise/golden-hour/dusk boundaries, DST and same-instant differences.');
